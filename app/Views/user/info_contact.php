...
<body class="bg-gray-50">
    ...
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <form method="post" action="/user/my-informations-contact/store" class="bg-white shadow-xl rounded-2xl p-8">
                <div class="mb-8">
                ...
                <div class="mt-8 flex justify-between">
                    <button
                        type="button"
                        onclick="window.location.href='/user/my-informations-clients'"
